...
export function AlgorithmSection({
  ...
  return (
    <section id={id} className={cn("py-6 md:py-10 border-b border-slate-800 last:border-b-0", className)}>
      <div className="container mx-auto px-2 sm:px-4">
        {title && <h2 className="text-3xl md:text-4xl font-bold text-sky-400 mb-6 md:mb-8 text-center">{title}</h2>}
        {explanationSlot}
